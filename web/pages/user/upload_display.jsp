...
<body>
	...
	<div id="header">
			...
			<span class="wel_word">Upload Management</span>
	...
	<div id="main">
		<table>
			...
			<c:forEach items="${requestScope.listuploadBooks}" var="book">
				<tr>
					<td>${book.name}</td>
					<td>${book.price}</td>
					<td>${book.owner}</td>
			...
			<tr>
				...
				<td></td>
				<td></td>
				<td><a href="pages/user/upload.jsp?pageNo=${requestScope.page.pageTotal}">Add goods</a></td>
			</tr>	
		</table>
